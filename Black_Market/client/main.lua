...
local v1 = vector3(184.37, -1513.55, 31.1)
-- 2d vector
local v2 = vector2(180.22, -1509.23)
-- '4d' vector 
local v3 = vector4(184.37, -1513.55, 31.1, 229.17)
...
local distance_until_text_disappears = 200
    ...
    while true do
        Citizen.Wait(0)
            ...
            if Vdist2(GetEntityCoords(PlayerPedId(), false), v1) < distance_until_text_disappears then
                Draw3DText(v1.x,v1.y,v1.z, "BLACK MARKET")
            end
    end
end)
